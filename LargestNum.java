...
public class LargestNum {
   public static void main(String[] args) {
      ...
      if (       ) { //fill in this if statement (in parens), for the condition where num1 is the largest
         System.out.println(num1+" is the largest num.");
      }
      else if (    ) { //fill in this if statement, for the condition where num2 is the largest
